...
public partial class MainPage : ContentPage
{
	...
	public MainPage()
		: this(Microsoft.Maui.IPlatformApplication.Current?.Services?.GetRequiredService<MainPageViewModel>()
			?? throw new InvalidOperationException("MainPageViewModel not registered in DI container"))
	{
	}
